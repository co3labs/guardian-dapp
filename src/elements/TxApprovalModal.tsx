...
export default function TxApprovalModal() {
  ...
  return (
    <>
      <div className="absolute top-0 right-0 left-0 bottom-0 bg-black z-20 bg-opacity-25 px-4">
        <div className="absolute left-0 right-0 md:right-auto md:left-1/2 top-1/2 md:-translate-x-1/2 -translate-y-1/2 px-4">
          <div className="bg-gray-100 flex flex-col p-6 rounded-sm border border-blue-800 shadow-lg">
            {txs.length > 0 ? (
              <>
